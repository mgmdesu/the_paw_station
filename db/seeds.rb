...
#   Character.create(name: 'Luke', movie: movies.first)
  ...
  #管理者ログイン情報
  # Admin.create!(email: 'admin@example.com', password: 'admin!')
  ...
  #ユーザー情報
  # User.create!([
  #   { name: 'JACK', email: 'jack@test.com', password: 'password', introduction: 'ジャック・ラッセル・テリアのジャック（10歳/♂）三度の飯より寝るのが好き...Zzz', profile_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-jack-user.jpg"), filename: "sample-jack-user.jpg") },
  #   { name: 'Leo', email: 'leo@test.com', password: 'password', introduction: 'レオ（５歳）ご飯とボールが大好き！犬コミュニケーション勉強中です。', profile_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-leo-user.jpg"), filename: "sample-leo-user.jpg") },
  #   { name: 'むぎ', email: 'mugi@test.com', password: 'password', introduction: 'ポメラニアンを飼っています。仲良くしてください！', profile_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-mugi-user.jpg"), filename: "sample-mugi-user.jpg") },
  #   { name: 'Lucy', email: 'lucy@test.com', password: 'password', introduction: '走るのが大好きです！', profile_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-lucy-user.jpg"), filename: "sample-lucy-user.jpg") },
  #   { name: 'チャド', email: 'chad@test.com', password: 'password', introduction: '始めたばかりです。よろしくお願いします！' },
  #   { name: 'マロン', email: 'maron@test.com', password: 'password', introduction: '冬がすき！', profile_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-maron-user.jpg"), filename: "sample-maron-user.jpg") },
  #   { name: 'ハナ', email: 'hana@test.com', password: 'password', introduction: 'これからドッグランデビューです♪よろしくお願いします。' },
  #   { name: 'CoCo', email: 'coco@test.com', password: 'password', introduction: 'ドッグラン大好きです！いっぱい更新していきます！' },
  #   { name: 'mocha', email: 'mocha@test.com', password: 'password', introduction: 'モカです！よろしくお願いします！' },
  #   { name: 'Aura', email: 'aura@test.com', password: 'password', introduction: 'ジャーマンシェパード・Aura（アウラ）怖がられがちですが、見かけによらず繊細です', profile_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-aura-user.jpg"), filename: "sample-aura-user.jpg") },
  #   ])
